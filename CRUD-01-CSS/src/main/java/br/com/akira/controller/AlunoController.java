...
public class AlunoController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (action.equals("listAluno")) {
			...
			List<Aluno> findByNameAluno = dao.findByNameAluno(a);
			
			request.setAttribute("findByNameAluno", findByNameAluno);
			request.getRequestDispatcher("WEB-INF/findByNameListAluno.jsp").forward(request, response);
		}
